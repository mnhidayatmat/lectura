        ...
        @php
            $toolGroups = [
                'Teach' => [
                    ...
                    ['Quizzes', 'Live quizzes', route('tenant.quizzes.index', $tenant->slug), 'amber', 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                ...
                'Class' => [
                    ['Attendance', 'QR check-in', route('tenant.attendance.index', $tenant->slug), 'emerald', 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'],
