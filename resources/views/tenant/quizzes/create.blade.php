<x-tenant-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-900">Create Quiz</h2>
                <p class="mt-1 text-sm text-slate-500">Add questions and launch a live session</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
            <div class="grid sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="title" required placeholder="e.g. Week 3 Review Quiz" class="w-full px-4 py-2.5 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" />
                </div>
                <div>
