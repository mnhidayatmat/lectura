<x-tenant-layout>
    ...
    @else
        <div class="space-y-6">
            @foreach($memberships as $courseId => $courseMembers)
                @php
                    $firstMembership = $courseMembers->first();
                    $course = $firstMembership->group->groupSet->course;
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="divide-y divide-slate-100 dark:divide-slate-700">
                        @foreach($courseMembers as $membership)
