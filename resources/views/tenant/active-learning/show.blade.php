            ...
            @if($plan->prerequisites)
                <div class="px-5 py-4 border-t border-slate-100">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <h4 class="text-xs font-semibold text-amber-700 uppercase tracking-wider">{{ __('active_learning.prerequisites') }}</h4>
                    </div>
                    <div class="text-sm text-slate-600 leading-relaxed whitespace-pre-line">{{ $plan->prerequisites }}</div>
                </div>
            @endif
        </div>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    @if($activity->instructions)
                                        <div class="bg-slate-50 rounded-xl p-4 mb-3 border border-slate-100">
                                            ...
                                            <div class="text-sm text-slate-600 leading-relaxed rich-instructions">{!! clean_html($activity->instructions) !!}</div>
                                        </div>
                                    @endif
