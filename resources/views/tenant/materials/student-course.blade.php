                                    ...
                                    @else
                                        <div class="flex items-center gap-2">
                                            @if($material->isPreviewable())
                                                <a href="{{ route('tenant.materials.view', [$tenant->slug, $course, $material]) }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-700 transition">
